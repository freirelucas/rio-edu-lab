...
**Estado atual:** 9 itens do data.rio referenciados por 18 papers no catálogo.
...
| `498e637753bd4e0da76e90103dd21eb7` | Mapa Digital do Rio de Janeiro - Escolas Municipais e Estratégia da Saúde | Web Map | 5 | Coleman et al. (1982) — _geometria de escolas_<br>Dupriez & Dumay (2006) — _geometria de escolas_<br>Schwartz (2011) — _geometria de escolas_<br>Coleman (1968) — _geometria de escolas_<br>Nye et al. (2004) — _geometria de escolas_ |
| `fa85ddc76a524380ad7fc60e3006ee97` | Índice de Desenvolvimento Social (IDS) por Áreas de Planejamento (AP), Regiões de Planejamento (RP), Regiões Administrativas (RA), Bairros e Favelas do Município do Rio de Janeiro - 2010 | Microsoft Excel | 5 | Coleman et al. (1982) — _INSE por escola_<br>Dupriez & Dumay (2006) — _INSE por escola_<br>Schwartz (2011) — _INSE por escola_<br>Coleman (1968) — _composição SES por bairro_<br>Oakes (1985) — _composição SES por bairro_ |
...
| `9fd1a8cc207a48c5bda7131e4e74b1ca` | IDEB das séries iniciais e finais segundo as Áreas de Planejamento (AP), Regiões de Planejamento (RP), Regiões Administrativas (RA) e Bairros do Município do Rio de Janeiro em 2007/2009/2011/2013/2015/2017/2019/2021/2023 | Microsoft Excel | 3 | Coleman (1968) — _desempenho por escola_<br>Oakes (1985) — _IDEB por bairro_<br>Nye et al. (2004) — _desempenho por escola_ |
...
| `d1e1192de4854ee4b53095a6f3274018` | Educação Infantil (pré-escola), Ensino Fundamental, Educação Especial, Programa de Educação Jovens e Adultos (PEJ): turmas e alunos matriculados na rede pública municipal, segundo Coordenação Regional de Educação (CRE) e matrícula final, entre 1999-2012  | Microsoft Excel | 2 | Oakes (1985) — _matrículas por escola_<br>Nye et al. (2004) — _matrículas por escola_ |
