...
> Pacote `acec` (legacy "Atlas Cibernético da Educação Carioca", retido como nome de pacote por compat) que provê estatísticas canônicas com invariantes de decomposição aditiva testadas em CI. Usado pelo **[rio-edu-lab](https://freirelucas.github.io/rio-edu-lab/)** — laboratório de replicação de papers em educação aplicados ao Rio.
